...
import 'package:islamicapp/model/data.morning.dart';
import 'package:islamicapp/views/main.page.views.dart';
import 'package:islamicapp/widgets/audio.screen.dart';
import 'package:islamicapp/widgets/card.widget.dart';
import 'package:islamicapp/widgets/card.widget.ex.dart';
...
class _MorningPageState extends State<MorningPage> with SingleTickerProviderStateMixin{

  bool isPlaying = false;
  bool _shouldDisposeAudio = false;
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context,index) {
                      return AnimatedListItem(
                        ...
                        CardWidget(
                          data: dataMorning,
                          image:  ImagesPath.morning,
                          text1: dataMorning[index].text1,
                          text2: dataMorning[index].text2,
                          text3: dataMorning[index].text3,
                          noRepeat: dataMorning[index].noRepeat,
                          audio:dataMorning[index].audio,
                          maxValue: dataMorning[index].maxValue,
                          id: index,
                          length: dataMorning.length,
                        ),
